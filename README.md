...
<table>
  <tr>
    <td valign="top" width="50%">
      <h2>👨‍💻 Sobre mim</h2>
      🎓 Graduando em <b>Ciência da Computação</b> em São Paulo.<br><br>
      💼 Experiência com <b>Suporte de TI</b>, ERP industrial e organização de dados.<br><br>
      🐍 Desenvolvimento de automações em Python para processos e relatórios.<br><br>
      📊 Interesse em <b>Dados, Infraestrutura e Tecnologia</b>.<br><br>
